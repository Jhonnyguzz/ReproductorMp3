...
public class Playlist extends Action implements Serializable {
  ...
  /**
   * This method add to ArrayList an instance of Song Class, to create a List of Songs
   *
  ...
  /**
   * This method add to ArrayList of Playlist class another ArrayList of Song class, to create a
   * List of Songs
   *
  ...
  /**
   * This method open Song with index k+1 in ArrayList, using method open from BasicPlayer 3.0
   * class
   *
  ...
  /**
   * This method open Song with index 0 in ArrayList, using method open from BasicPlayer 3.0 class
   *
   * @throws BasicPlayerException
   */
  public void putInMemoryFirst() {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(null, "No se pudo cargar la canci\u00F3n", "Error",
  ...
  /**
   * Remove all elements in ArrayList of Playlist class and open a File null using method open from
